...
const PROJECTS = [
  { name: "InsureSense", desc: "InsureSense is a machine learning–driven system that analyzes customer data to predict the likelihood of an insurance client accepting a policy offer, helping businesses target potential customers more effectively.", tags: ["", "Spark", "ML", "K8s"], stars: 0, image: "https://wpblogassets.paytm.com/paytmblog/uploads/2021/09/15_Insurance_-What-is-Vehicle-Insurance-800x500.jpg", github: "https://github.com/jvpurushotham/InsureSense-Smart-Customer-Response-Predictor", live: "https://github.com/jvpurushotham/InsureSense-Smart-Customer-Response-Predictor" },
  { name: "Smart Hospital Queue System", desc: "A smart hospital queue management system allows patients to book tokens online and track real-time queue status. Built using Django and modern web technologies to streamline appointment scheduling, authentication, and notifications.", tags: ["Terraform", "AWS", "GCP", "Go"], stars: 0, image: "https://www.bestdocapp.com/wp-content/uploads/2021/12/14-01.png", github: "https://github.com/jvpurushotham/smart-hospital-queue-system", live: "https://github.com/jvpurushotham/smart-hospital-queue-system" },
  { name: "QuickCart", desc: "QuickCart is a full-stack grocery delivery web application developed using Django and JavaScript, featuring category-based product browsing, an intelligent cart system, real-time order tracking, and secure user authentication.", tags: ["FastAPI", "React", "NLP", "PostgreSQL"], stars: 0, image: "https://png.pngtree.com/png-vector/20250217/ourlarge/pngtree-friendly-grocery-delivery-person-holding-bags-bringing-fresh-food-and-smiles-png-image_15504176.png", github: "https://github.com/jvpurushotham/QuickCart", live: "https://quickcart-bhq2.onrender.com/admin/" },
  { name: "Netflix Customer Churn Prediction", desc: "A machine learning–based churn prediction system for Netflix that analyzes user activity patterns, viewing history, subscription plans, and engagement metrics to forecast the likelihood of customers cancelling their subscriptions.", tags: ["Python", "Docker", "CV", "Redis"], stars: 0, image: "https://www.taboola.com/wp-content/uploads-neo/2025/04/customer-churn.jpg", github: "https://github.com/jvpurushotham/Netflix-Customer-Churn-Prediction", live: "https://netflix-customer-churn-model.streamlit.app" },
  { name: "Electronic Review Analysis", desc: "This project is a sentiment analysis project using machine learning to analyze Flipkart electronics reviews, uncover customer insights, and identify product trends that support data-driven consumer decisions and business strategies.", tags: ["React", "Airflow", "SQL", "Python"], stars: 0, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIXprp-rCmM3z3MGEKKBO6Tc3HVN8sMpEgpQ&s", github: "https://github.com/jvpurushotham/Electronics-Review-Analysis", live: "https://electronics-review-analysis-laptops-dashboard.streamlit.app" },
  { name: "Optimal Fertilizer Prediction", desc: "A data-driven fertilizer recommendation system powered by XGBoost that analyzes soil and environmental factors to predict the most suitable fertilizer, helping improve crop productivity and agricultural decision-making.", tags: ["Node.js", "Redis", "GraphQL", "Docker"], stars: 0, image: "https://4.imimg.com/data4/BN/XU/MY-311945/organic-fertilizer-500x500.jpg", github: "https://github.com/jvpurushotham/Optimal-Fertilizer-Prediction", live: "https://optimal-fertilizer-prediction-model.streamlit.app" },
];
